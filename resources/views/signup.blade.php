...
<html lang="en">
    ...
    <x-navbar>
        <div class="flex items-center mt-6 px-10">
            ...
            <form action="/register" method="POST" class="flex flex-1 flex-col items-center px-10">
                @csrf
                ...
                <div class="grid grid-col-2 gap-3 mt-8 self-stretch">
                    ...
                    <div
                        class="p-2 border border-gray flex gap-3 items-center rounded
                        text-gray-400
                    ...
                    <div
                        ...
                        <i class="fa-solid fa-calendar-days"></i> <input value="{{ old('age') }}" name="age"
                            id="age-register" class="w-full focus:outline-0 text-black" type="number" min="0"
                            max="120" autocomplete="off" placeholder="Age" />
                    </div>
                    ...
                    <div
                        ...
                        <input value="{{ old('telephone') }}" name="telephone" id="telephone-register"
                            ...
                            pattern="[+]?[0-9]+" placeholder="Téléphone" />
                    </div>

                    <div
                        class="select-element-div p-2 border border-gray flex gap-3 items-center rounded
                        text-primary transition linear cursor-pointer border-primary">
                        <i class="fa-solid fa-city"></i>
                        <select class="w-full focus:outline-0 cursor-pointer text-black" name="ville"
                            id="ville-register">
                            {{-- <option value="{{ old('ville') }}" selected hidden>
                                {{ old('ville') ? old('ville') : 'Ville de résidence' }}</option> --}}
                            <option value="Tetouan" selected>Tetouan</option>
                    ...
                    <div
                        ...
                        <input value="{{ old('username') }}" name="username" id="username-register"
                            class="w-full focus:outline-0 text-black" type="text" placeholder="Nom d'utilisateur"
                            autocomplete="off" />
                    </div>

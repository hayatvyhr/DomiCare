            ...
            <div class="grid grid-col-2 gap-3 mt-8 self-stretch">
                ...
                <div
                    ...
                    <input value="{{ old('prenom') }}" name="prenom" id="prenom-register"
                        class="w-full focus:outline-0 text-black"autocomplete="off" type="text" autocomplete="off"
                ...
                <div
                    ...
                    <input value="{{ old('nom') }}" name="nom" id="nom-register"
                        class="w-full focus:outline-0 text-black" type="text" autocomplete="off" placeholder="Nom"
                        required />
                </div>
                ...
                <div
                    ...
                    <i class="fa-solid fa-calendar-days"></i> <input value="{{ old('age') }}" name="age"
                        ...
                        max="120" autocomplete="off" placeholder="Age" required />
                </div>

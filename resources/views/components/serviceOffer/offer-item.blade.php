<div
    ...
    <img src="/storage/partenaires/{{ $service->partenaire->image }}" alt="profile image"
        class=" w-32 rounded-full border-2 border-gray-800 hover:border-primary hover:scale-105 transition">
    ...
    <div class="flex items-center gap-1 text-[#FFBF00] text-[16px]">
        ...
        @endfor
        @if ($service->rating - floor($service->rating) > 0.3)
            <i class="fa-solid fa-star-half-stroke"></i>
        @else
            <i class="fa-regular fa-star"></i>
        @endif
        @for ($i = ceil($service->rating); $i < 5; $i++)
            <i class="fa-regular fa-star"></i>
        @endfor
